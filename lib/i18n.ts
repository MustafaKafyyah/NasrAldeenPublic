...
const dict = {
  ar: {
    ...
    welcomeThanks:
      "بمساعدة زكي بن مصطفى بن علي بن بلال بن نصرالدين، وياسين بن ابراهيم بن قاسم بن عبدالحكيم بن مسرعلي بن نصرالدين، وعماد بن عبدالحكيم بن قاسم بن عبدالحكيم بن مسرعلي بن نصرالدين، وماهر بن عمر علان بن عبدالحميد بن مسرعلي بن نصرالدين في جمع أسماء العائلة.",
    welcomeBuiltTitle: "بناء الموقع",
    welcomeBuilt: "مصطفى بن غازي بن مصطفى بن علي بن بلال بن نصرالدين، وماجد بن محمد بن مصطفى بن علي بن بلال بن نصرالدين.",
    welcomeStart: "ابدأ",
    daughter: "بنت",
    son: "ابن",
    of: "من",
  ...
  en: {
    ...
    welcomeThanks:
      "Zaki bin Mustafa bin Ali bin Bilal bin NasrAldeen, Yaseen bin Ibrahim bin Qassim bin Abdulhakeem bin Misr Ali bin NasrAldeen, Imad bin Abdulhakeem bin Qassim bin Abdulhakeem bin Misr Ali bin NasrAldeen and Maher bin Omar Allan bin Abdulhameed bin Misr Ali bin NasrAldeen, for their help gathering the family’s names.",
    welcomeBuiltTitle: "Built by",
    welcomeBuilt: "Mustafa bin Ghazi bin Mustafa bin Ali bin Bilal bin NasrAldeen and Majid bin Muhammad bin Mustafa bin Ali bin Bilal bin NasrAldeen.",
    welcomeStart: "Start",
    daughter: "daughter",
    son: "son",
    of: "of",
