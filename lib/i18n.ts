...
const dict = {
  ar: {
    ...
    hintMobileList: "المس اسماً ليضيء نسبه · المس العلامة لفتح الفرع · قرّب بإصبعين",
  ...
  en: {
    ...
    hintMobileList: "Tap a name to light its lineage · tap the mark to open a branch · pinch to zoom",
